...
public class LoginCheckAspect {
    ...
    public Object adminLoginCheck(ProceedingJoinPoint proceedingJoinPoint, LoginCheck loginCheck) throws Throwable {
        ...
        ServletRequestAttributes serveleteRequestAttributes = (ServletRequestAttributes) (RequestContextHolder.currentRequestAttributes());
        HttpSession session = (HttpSession) (serveleteRequestAttributes).getRequest().getSession();
        ...
        return proceedingJoinPoint.proceed(modifiedArgument);
    }
