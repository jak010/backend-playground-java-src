...
class BronzeDiscountPolicy extends AbstractDiscount implements DiscountPolicy {

    public BronzeDiscountPolicy() {
        this.discountRate = 0.95;
        this.max_price = 300_000;
        this.min_price = 100_000;
    }
...
class SilverDiscountPolicy extends AbstractDiscount implements DiscountPolicy {

    public SilverDiscountPolicy() {
        this.discountRate = 0.9;
        this.max_price = 500_000;
        this.min_price = 300_000;
    }
...
class GoleDiscountPolicy extends AbstractDiscount implements DiscountPolicy {

    public GoleDiscountPolicy() {
        this.discountRate = 0.8;
        this.min_price = 500_000;
    }
